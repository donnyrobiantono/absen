...
class ClockInDalam extends StatefulWidget {
  @override
  _ClockInDalamState createState() => _ClockInDalamState();
}

class _ClockInDalamState extends State<ClockInDalam> {
  ...
  Future masuk() async {
    ...
    var url = Uri.parse('https://cobadonny.uptbali.com/clockindalam.php?nip=' +
        value1 +
        '&atasan=' +
        value2 +
        '&bagian=' +
