...
class _ClockOutState extends State<ClockOut> {
  ...
  void startbulan() {
    ...
    var formatedbulan = new DateFormat.MMMM().format(bln);
    if (formatedbulan == 'January') {
      setState(() {
        formatedbulan = 'Januari';
      });
    } else if (formatedbulan == 'February') {
      setState(() {
        formatedbulan = 'Februari';
      });
    } else if (formatedbulan == 'March') {
      setState(() {
        formatedbulan = 'Maret';
      });
    } else if (formatedbulan == 'April') {
      setState(() {
        formatedbulan = 'April';
      });
    } else if (formatedbulan == 'May') {
      setState(() {
        formatedbulan = 'Mei';
      });
    } else if (formatedbulan == 'June') {
      setState(() {
        formatedbulan = 'Juni';
      });
    } else if (formatedbulan == 'July') {
      setState(() {
        formatedbulan = 'Juli';
      });
    } else if (formatedbulan == 'August') {
      setState(() {
        formatedbulan = 'Agustus';
      });
    } else if (formatedbulan == 'September') {
      setState(() {
        formatedbulan = 'September';
      });
    } else if (formatedbulan == 'October') {
      setState(() {
        formatedbulan = 'Oktober';
      });
    } else if (formatedbulan == 'November') {
      setState(() {
  ...
  Future masukluar() async {
    ...
    var uri = Uri.parse('https://cobadonny.uptbali.com/clockout.php?nip=' +
        value1 +
        '&atasan=' +
        value2 +
        '&bagian=' +
